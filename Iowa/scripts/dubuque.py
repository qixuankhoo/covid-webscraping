...
with open(r"C:\Users\Raghav's Computer\Covid Muser\data\dubuque.txt",'w', encoding='utf-8') as outfile:
...
if len(pdfs)>0: #Only creates folder if the website has pdfs
    folder_location = r"C:\Users\Raghav's Computer\Covid Muser\data\dubuque-PDF"
