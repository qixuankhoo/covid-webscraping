...
if len(pdfs)>0: #Only creates folder if the website has pdfs
    folder_location = r"C:\Users\Raghav's Computer\Covid Muser\cumberland-PDF"
...
with open(r"C:\Users\Raghav's Computer\Covid Muser\data\cumberland.txt",'w', encoding='utf-8') as outfile:
